...
class AddEditMemberScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AddEditMemberScreen> createState() => _AddEditMemberScreenState();
}
    ...
    try {
      ...
      if (_isEditing) {
        await repo.updateMember(
          widget.existing!.copyWith(name: name, phone: phone, clearPhone: phone.isEmpty),
        );
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("Couldn't save this member. Please try again.")),
        );
      }
    } finally {
